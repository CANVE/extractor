...
object Output {
  ...
  val outputPath = new DataIO(PluginArgs.outputRootPath) 
  ...
  def write(implicit extractedModel: ExtractedModel) = {
    ...
    outputPath.writeOutputFile(PluginArgs.projectName, "symbols", 
    ...
    outputPath.writeOutputFile(PluginArgs.projectName, "relations", 
        "id1,relation,id2\n" +
